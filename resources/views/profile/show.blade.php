...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden">
        <div class="p-6">
            ...
            <!-- Society Information (if applicable) -->
            @if(auth()->user()->society_id)
                <div class="mt-6 pt-6 border-t border-gray-200">
                    <h3 class="text-lg font-semibold text-gray-900 mb-4">Society Information</h3>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Society Name</label>
                            <p class="text-gray-900">{{ auth()->user()->society->name ?? 'N/A' }}</p>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Society Location</label>
                            <p class="text-gray-900">{{ auth()->user()->society->city ?? 'N/A' }}, {{ auth()->user()->society->state ?? 'N/A' }}</p>
                        </div>
                    </div>
                </div>
            @endif
