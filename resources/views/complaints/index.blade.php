...
@section('title', 'Complaints & Tickets')
@section('page-title', 'Complaints & Tickets')
...
<div class="container mx-auto px-4 py-6">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-semibold text-gray-900">{{ $stats['in_progress_complaints'] }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-semibold text-gray-900">{{ $stats['resolved_complaints'] }}</p>
                </div>
            </div>
        </div>
    ...
    <div class="bg-white rounded-lg shadow p-4 mb-6">
        <form method="GET" action="{{ route('complaints.index') }}" class="flex flex-wrap gap-4">
            ...
            <div>
                <select name="priority" class="px-3 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">
            ...
            <div>
                <select name="category_id" class="px-3 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">
            ...
            @if(request()->hasAny(['search', 'status', 'priority', 'category_id']))
                <a href="{{ route('complaints.index') }}" class="px-4 py-2 bg-gray-300 text-gray-700 rounded-lg hover:bg-gray-400">
                    Clear
                </a>
            @endif
        </form>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($complaints as $complaint)
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900">{{ $complaint->createdBy->name ?? 'N/A' }}</div>
                                <div class="text-sm text-gray-500">{{ $complaint->society->name ?? 'N/A' }}</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex space-x-2">
                                    ...
                                    <a href="{{ route('complaints.edit', $complaint) }}" class="text-indigo-600 hover:text-indigo-900">
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="px-6 py-4 text-center text-gray-500">
                                No complaints found. <a href="{{ route('complaints.create') }}" class="text-blue-600 hover:text-blue-800">Register your first complaint</a>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
